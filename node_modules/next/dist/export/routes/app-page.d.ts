...
export declare function generatePrefetchRsc(req: MockedRequest, path: string, res: MockedResponse, pathname: string, query: NextParsedUrlQuery, htmlFilepath: string, renderOpts: RenderOpts): Promise<void>;
