...
const OpenApi3_1DereferenceVisitor = (0, _stampit.default)({
  ...
  methods: {
    ...
    async ReferenceElement(referencingElement, key, parent, path, ancestors) {
      ...
      const reference = await this.toReference((_referencingElement$$ = referencingElement.$ref) == null ? void 0 : _referencingElement$$.toValue());
      const {
        uri: retrievalURI
      } = reference;
      const $refBaseURI = url.resolve(retrievalURI, (_referencingElement$$2 = referencingElement.$ref) == null ? void 0 : _referencingElement$$2.toValue());
      ...
      referencedElement.setMetaProperty('ref-fields', {
        $ref: (_referencingElement$$3 = referencingElement.$ref) == null ? void 0 : _referencingElement$$3.toValue(),
        // @ts-ignore
        description: (_referencingElement$d = referencingElement.description) == null ? void 0 : _referencingElement$d.toValue(),
        // @ts-ignore
        summary: (_referencingElement$s = referencingElement.summary) == null ? void 0 : _referencingElement$s.toValue()
      });
    ...
    async PathItemElement(referencingElement, key, parent, path, ancestors) {
      ...
      const reference = await this.toReference((_referencingElement$$4 = referencingElement.$ref) == null ? void 0 : _referencingElement$$4.toValue());
      const {
        uri: retrievalURI
      } = reference;
      const $refBaseURI = url.resolve(retrievalURI, (_referencingElement$$5 = referencingElement.$ref) == null ? void 0 : _referencingElement$$5.toValue());
      this.indirections.push(referencingElement);
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)($refBaseURI);
      ...
      mergedResult.setMetaProperty('ref-fields', {
        $ref: (_referencingElement$$6 = referencingElement.$ref) == null ? void 0 : _referencingElement$$6.toValue()
      });
    ...
    async LinkElement(linkElement) {
      ...
      if ((0, _apidomCore.isStringElement)(linkElement.operationRef)) {
        ...
        // possibly non-semantic referenced element
        const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((_linkElement$operatio = linkElement.operationRef) == null ? void 0 : _linkElement$operatio.toValue());
        const reference = await this.toReference((_linkElement$operatio2 = linkElement.operationRef) == null ? void 0 : _linkElement$operatio2.toValue());
        ...
        const operationId = (_linkElement$operatio4 = linkElement.operationId) == null ? void 0 : _linkElement$operatio4.toValue();
    ...
    async ExampleElement(exampleElement) {
      ...
      const reference = await this.toReference((_exampleElement$exter = exampleElement.externalValue) == null ? void 0 : _exampleElement$exter.toValue());
    ...
    async SchemaElement(referencingElement, key, parent, path, ancestors) {
      ...
      if ((0, _apidomNsOpenapi.isBooleanJsonSchemaElement)(referencedElement)) {
        ...
        referencedElementClone.setMetaProperty('ref-fields', {
          $ref: (_referencingElement$$7 = referencingElement.$ref) == null ? void 0 : _referencingElement$$7.toValue()
        });
        // annotate referenced element with info about origin
      ...
      // annotate referenced element with info about original referencing element
      mergedResult.setMetaProperty('ref-fields', {
        $ref: (_referencingElement$$8 = referencingElement.$ref) == null ? void 0 : _referencingElement$$8.toValue()
      });
      // annotate fragment with info about origin
      mergedResult.setMetaProperty('ref-origin', reference.uri);
