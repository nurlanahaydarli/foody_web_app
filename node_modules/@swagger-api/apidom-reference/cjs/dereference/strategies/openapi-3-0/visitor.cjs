...
const OpenApi3_0DereferenceVisitor = (0, _stampit.default)({
  ...
  methods: {
    ...
    async PathItemElement(referencingElement, key, parent, path, ancestors) {
      ...
      const reference = await this.toReference((_referencingElement$$3 = referencingElement.$ref) == null ? void 0 : _referencingElement$$3.toValue());
      const retrievalURI = reference.uri;
      const $refBaseURI = url.resolve(retrievalURI, (_referencingElement$$4 = referencingElement.$ref) == null ? void 0 : _referencingElement$$4.toValue());
      this.indirections.push(referencingElement);
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)($refBaseURI);
      ...
      mergedResult.setMetaProperty('ref-fields', {
        $ref: (_referencingElement$$5 = referencingElement.$ref) == null ? void 0 : _referencingElement$$5.toValue()
      });
