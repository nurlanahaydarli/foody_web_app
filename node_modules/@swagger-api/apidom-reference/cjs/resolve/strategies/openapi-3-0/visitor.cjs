...
const OpenApi3_0ResolveVisitor = (0, _stampit.default)({
  ...
  methods: {
    ...
    ReferenceElement(referenceElement) {
      ...
      const uri = (_referenceElement$$re = referenceElement.$ref) == null ? void 0 : _referenceElement$$re.toValue();
      const baseURI = this.toBaseURI(uri);
    ...
    PathItemElement(pathItemElement) {
      ...
      const uri = (_pathItemElement$$ref = pathItemElement.$ref) == null ? void 0 : _pathItemElement$$ref.toValue();
      const baseURI = this.toBaseURI(uri);
      if (!(0, _ramda.has)(baseURI, this.crawlingMap)) {
        this.crawlingMap[baseURI] = this.toReference(uri);
      }
    ...
    LinkElement(linkElement) {
      ...
      if ((0, _apidomNsOpenapi.isLinkElementExternal)(linkElement)) {
        ...
        const uri = (_linkElement$operatio = linkElement.operationRef) == null ? void 0 : _linkElement$operatio.toValue();
        const baseURI = this.toBaseURI(uri);
        if (!(0, _ramda.has)(baseURI, this.crawlingMap)) {
          this.crawlingMap[baseURI] = this.toReference(uri);
        }
    ...
    ExampleElement(exampleElement) {
      ...
      const uri = (_exampleElement$exter = exampleElement.externalValue) == null ? void 0 : _exampleElement$exter.toValue();
      const baseURI = this.toBaseURI(uri);
      if (!(0, _ramda.has)(baseURI, this.crawlingMap)) {
        this.crawlingMap[baseURI] = this.toReference(uri);
      }
    ...
    async crawlReferenceElement(referenceElement) {
      ...
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((_referenceElement$$re2 = referenceElement.$ref) == null ? void 0 : _referenceElement$$re2.toValue());
    ...
    async crawlPathItemElement(pathItemElement) {
      ...
      // @ts-ignore
      const reference = await this.toReference((_pathItemElement$$ref2 = pathItemElement.$ref) == null ? void 0 : _pathItemElement$$ref2.toValue());
      this.indirections.push(pathItemElement);
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((_pathItemElement$$ref3 = pathItemElement.$ref) == null ? void 0 : _pathItemElement$$ref3.toValue());
