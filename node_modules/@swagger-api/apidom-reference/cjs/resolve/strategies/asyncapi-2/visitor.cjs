...
const AsyncApi2ResolveVisitor = (0, _stampit.default)({
  ...
  methods: {
    ...
    ChannelItemElement(channelItemElement) {
      ...
      const uri = (_channelItemElement$$ = channelItemElement.$ref) == null ? void 0 : _channelItemElement$$.toValue();
      const baseURI = this.toBaseURI(uri);
      if (!(0, _ramda.has)(baseURI, this.crawlingMap)) {
        this.crawlingMap[baseURI] = this.toReference(uri);
      }
    ...
    async crawlReferenceElement(referenceElement) {
      ...
      // @ts-ignore
      const reference = await this.toReference((_referenceElement$$re2 = referenceElement.$ref) == null ? void 0 : _referenceElement$$re2.toValue());
      this.indirections.push(referenceElement);
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((_referenceElement$$re3 = referenceElement.$ref) == null ? void 0 : _referenceElement$$re3.toValue());
    ...
    async crawlChannelItemElement(channelItemElement) {
      ...
      const reference = await this.toReference((_channelItemElement$$2 = channelItemElement.$ref) == null ? void 0 : _channelItemElement$$2.toValue());
      this.indirections.push(channelItemElement);
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((_channelItemElement$$3 = channelItemElement.$ref) == null ? void 0 : _channelItemElement$$3.toValue());
