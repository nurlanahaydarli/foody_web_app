          ...
          parentPathItem.parameters.forEach(parameter => {
            ...
            if ((0, _apidomNsOpenapi.isStringElement)(parameter.in) && (0, _apidomNsOpenapi.isStringElement)(parameter.name) && ((_parameter$in = parameter.in) == null ? void 0 : _parameter$in.toValue()) === 'header') {
              ...
              standardIdentifiers.push({
                ...
                value: (_parameter$name = parameter.name) == null ? void 0 : _parameter$name.clone()
              });
              standardIdentifiers.push({
                subject: ['http', 'message', 'header'],
                value: (_parameter$name2 = parameter.name) == null ? void 0 : _parameter$name2.clone()
              });
            }
          });
        }
      ...
      ParameterElement(element) {
        ...
        if ((0, _apidomNsOpenapi.isStringElement)(element.in) && (0, _apidomNsOpenapi.isStringElement)(element.name) && ((_element$in = element.in) == null ? void 0 : _element$in.toValue()) === 'header') {
          ...
          element.setMetaProperty('ads-a-standard-identifier', [{
            subject: ['http', 'request', 'header'],
            value: (_element$name = element.name) == null ? void 0 : _element$name.clone()
          }, {
            subject: ['http', 'message', 'header'],
            value: (_element$name2 = element.name) == null ? void 0 : _element$name2.clone()
          }]);
        }
      },
