  ...
  return {
    visitor: {
      OperationElement: {
        enter(element, ...rest) {
          ...
          parentPathItem == null || (_parentPathItem$param = parentPathItem.parameters) == null || _parentPathItem$param.forEach(parameter => {
            var _parameter$in;
            if ((0, _apidomNsOpenapi.isStringElement)(parameter.in) && (0, _apidomNsOpenapi.isStringElement)(parameter.name) && ((_parameter$in = parameter.in) == null ? void 0 : _parameter$in.toValue()) === 'header') {
              var _parameter$name, _parameter$name2;
              operationIdentifiers.push(['http', 'request', 'header'], ['http', 'request', 'header', (_parameter$name = parameter.name) == null ? void 0 : _parameter$name.toValue()], ['http', 'message', 'header'], ['http', 'message', 'header', (_parameter$name2 = parameter.name) == null ? void 0 : _parameter$name2.toValue()]);
            }
          });
        },
        leave(element) {
      ...
      ParameterElement(element) {
        var _element$in;
        if ((0, _apidomNsOpenapi.isStringElement)(element.in) && (0, _apidomNsOpenapi.isStringElement)(element.name) && ((_element$in = element.in) == null ? void 0 : _element$in.toValue()) === 'header') {
          var _element$name, _element$name2;
          operationIdentifiers.push(['http', 'request', 'header'], ['http', 'request', 'header', (_element$name = element.name) == null ? void 0 : _element$name.toValue()], ['http', 'message', 'header'], ['http', 'message', 'header', (_element$name2 = element.name) == null ? void 0 : _element$name2.toValue()]);
        }
      },
