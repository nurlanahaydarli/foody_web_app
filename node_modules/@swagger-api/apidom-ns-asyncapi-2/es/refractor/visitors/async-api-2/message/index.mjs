...
const MessageVisitor = stampit(FixedFieldsVisitor, FallbackVisitor, {
  ...
  methods: {
    ObjectElement(objectElement) {
      ...
      const schemaFormat = defaultTo(mediaTypes.latest(), (_objectElement$get = objectElement.get('schemaFormat')) === null || _objectElement$get === void 0 ? void 0 : _objectElement$get.toValue());
