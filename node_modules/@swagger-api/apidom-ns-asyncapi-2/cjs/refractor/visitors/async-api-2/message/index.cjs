...
const MessageVisitor = (0, _stampit.default)(_FixedFieldsVisitor.default, _FallbackVisitor.default, {
  ...
  methods: {
    ObjectElement(objectElement) {
      ...
      const schemaFormat = (0, _ramda.defaultTo)(_mediaTypes.default.latest(), (_objectElement$get = objectElement.get('schemaFormat')) == null ? void 0 : _objectElement$get.toValue());
