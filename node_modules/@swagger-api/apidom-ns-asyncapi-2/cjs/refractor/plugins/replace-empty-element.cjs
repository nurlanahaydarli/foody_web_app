...
const schema = {
  ...
  MessageElement: {
    ...
    payload(...args) {
      ...
      const schemaFormat = (0, _ramda.defaultTo)(_mediaTypes.default.latest(), (_messageElement$schem = messageElement.schemaFormat) == null ? void 0 : _messageElement$schem.toValue());
