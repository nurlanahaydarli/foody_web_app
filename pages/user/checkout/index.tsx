                ...
                <div className='px-8 pt-1 pb-[100px]'>
                    <div className='flex flex-row'>
                        ...
                        {checkoutComplete ? (
                            ...
                            <>
                                <div className='w-6/12 mx-5 mt-5 bg-cardColor p-4 bg-rounded-md shadow-md'>
                                    ...
                                    <div class="flex ml-6 mt-4">
                                        <button onClick={handleToggle}>
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="29" height="29" rx="14.5" fill="white" stroke="#6FCF97" />
                                                {isRectVisible2 && <rect x="8" y="8" width="15" height="15" rx="7.5" fill="#6FCF97" />}
                                            </svg>
                                        </button>
                                        ...
                                        <button className=' ml-16' onClick={handleToggle2}>
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="0.5" y="0.5" width="29" height="29" rx="14.5" fill="white" stroke="#6FCF97" />
                                                {isRectVisible && <rect x="8" y="8" width="15" height="15" rx="7.5" fill="#6FCF97" />}
                                            </svg>
                                        </button>
                        ...
                        <div className=' w-4/12 h-5/6 mt-5 bg-cardColor rounded-md shadow-md'>
                         ...
                         <div className='flex ml-9 mt-6'>
                            ...
                            <h5 className='text-grayText mt-1 text-lg'>x Papa John’s Pizza Restaurant</h5>
