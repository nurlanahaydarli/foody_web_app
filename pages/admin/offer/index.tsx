...
export default function Offer() {
    ...
    return (
        <>
            ...
            setIMG={setImg}
            >
                <Input hasLabel={true} title={'Title'} type={'text'} input_name={'Offer_Title'} Ref={inpTitle} value={Titlevalue} />
                <div className=" text-red-600">{TitleYup}</div>
                <Input hasLabel={true} title={'Name'} type={'text'} input_name={'product_name'} Ref={inpDesc} value={DescValue}/>
